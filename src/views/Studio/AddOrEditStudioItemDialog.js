...
export function AddOrEditStudioItemDialog({open, data, handleClose, onSubmit}) {
    let schema = yup.object().shape({
       // imageOrVideo: yup.string().required().nullable()
    });
    ...
    return (
        <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title"
            ...
            <form onSubmit={handleSubmit(handleOnSubmit)}>
                <DialogTitle id="form-dialog-title">Studio Item</DialogTitle>
                <DialogContent>
                        ...
                        <Grid item>
                            <Controller
                                ...
                                render={({onChange, value}) => <DropZone onChange={onChange} value={value}
                                                                         ...
                                                                         helperText={errors.imageOrVideo && errors.imageOrVideo.message}
                                />}
                            />
                        </Grid>
                    </Grid>
